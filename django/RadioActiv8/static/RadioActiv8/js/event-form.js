    ...
    success: function (data) {
...

      {
        ...
        if (data.intelligence_options.random)
          random_intelligence = Math.floor(
            Math.random() * data.intelligence_options.unused.length
          );
        ...
        for (var i = 0; i < data.intelligence_options.unused.length; i++) {
          ...
          if (selected_intelligence) {
            if (int.id == selected_intelligence) {
              ...
              jQuery("#intelligence_suggestion").html(
                "Q: " + int.q + "? <br>A: " + int.a
              );
            } else var selected = "";
...

      {
        ...
        for (var i = 0; i < data.base_history.visited_bases.length; i++) {
          ...
          base_history +=
            "<li data.base_history-base-id='" + id + "'>" + name + "</li>";
        }
        ...
        if (
          ...
          jQuery("#expected_location").append(
            "<strong>&nbsp;### WARNING! LOCATION MISMATCH! ###</strong>"
          );
